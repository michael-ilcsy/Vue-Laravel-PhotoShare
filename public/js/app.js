...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'Footer',
  computed: _objectSpread({}, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapState"])(['apiStatus']), Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapGetters"])({
    isLogin: 'auth/check'
  })),
  methods: {
    logout: function () {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: _objectSpread({
    isLoginTab: function isLoginTab() {
      return this.tab === LOGIN;
    },
    isRegisterTab: function isRegisterTab() {
      return this.tab === REGISTER;
    },
    loginClass: function loginClass() {
      return {
        'tab__item--active': this.isLoginTab
      };
    },
    registerClass: function registerClass() {
      return {
        'tab__item--active': this.isRegisterTab
      };
    }
  }, Object(vuex__WEBPACK_IMPORTED_MODULE_1__["mapState"])('auth', ['apiStatus', 'loginErrorMessages', 'registerErrorMessages'])),
  methods: {
    login: function () {
    ...
    loginTabClick: function loginTabClick() {
      this.tab = LOGIN;
    },
    registerTabClick: function registerTabClick() {
      this.tab = REGISTER;
    },
    ...
    _c("ul", { staticClass: "tab" }, [
      _c(
        "li",
        {
          ...
          class: _vm.loginClass,
          on: { click: _vm.loginTabClick }
        },
        [_vm._v("Login\n    ")]
      ),
      _vm._v(" "),
      _c(
        ...
        {
          staticClass: "tab__item",
          class: _vm.registerClass,
          on: { click: _vm.registerTabClick }
        },
        [_vm._v("Register\n    ")]
      )
    ]),
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.isLoginTab,
            expression: "isLoginTab"
          }
        ],
        staticClass: "panel"
      },
        ...
        directives: [
          {
            name: "show",
            rawName: "v-show",
            value: _vm.isRegisterTab,
            expression: "isRegisterTab"
          }
        ],
        staticClass: "panel"
      },
            ...
            _vm.registerErrorMessages
              ? _c("div", { staticClass: "errors" }, [
                  ...
                  _vm.registerErrorMessages.password
                    ? _c(
                        "ul",
                        _vm._l(_vm.registerErrorMessages.password, function(
                          msg
                        ) {
                          return _c("li", { key: msg }, [_vm._v(_vm._s(msg))])
                        }),
...
/* harmony import */ var _pages_PhotoList__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./pages/PhotoList */ "./resources/js/pages/PhotoList.vue");
...
var routes = [{
  path: '/',
  component: _pages_PhotoList__WEBPACK_IMPORTED_MODULE_2__["default"]
}, {
  path: '/login',
...
var actions = {
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              if (!(status === _util__WEBPACK_IMPORTED_MODULE_1__["CREATED"])) {
                _context.next = 11;
                break;
              }
            ...
            case 11:
              ...
              if (status === _util__WEBPACK_IMPORTED_MODULE_1__["UNPROCESSABLE_ENTITY"]) {
                commit('setRegisterErrorMessages', data.errors);
              } else {
                commit('error/setCode', status, {
                  root: true
                });
              }
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              if (!(status === _util__WEBPACK_IMPORTED_MODULE_1__["OK"])) {
                _context2.next = 11;
                break;
              }
  ...
  currentUser: function () {
    ...
    _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee4(_ref7) {
      var commit, _ref8, status, data, user;
...
__webpack_require__(/*! C:\Users\user\Homestead\projects\PhotoShare\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\user\Homestead\projects\PhotoShare\resources\sass\app.scss */"./resources/sass/app.scss");
